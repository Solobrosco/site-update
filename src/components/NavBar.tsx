...
const NavBar = (props: NavBarProps) => {
    ...
    return(
        <div className='bg-gruvbg-0 border-b-4 border-gray-900 shadow-md sticky top-0 cursor-default text-gruvwhite'>
            <div className="flex inline-block align-middle px-3 py-3 text-center">
                ...
                <div className='w-1/3 text-right'>
                    <button type='button' className='' onClick={() => setOpen(!open)}>
                        ...
                        <svg className='h-6 w-6 fill-current hover:text-graygruv-light' id="Layer_1" enableBackground="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
